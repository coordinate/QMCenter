...
#
#     def add_fly(self, filename=r'D:\a.bulygin\QMCenter_projects\qwer.files\Magnet\test_fly.magnete'):
...
#             return
#         if visible == "Off":
#             self.object_list[name].setVisible(False)
#         elif visible == "On":
#             self.object_list[name].setVisible(True)
