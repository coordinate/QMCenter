...
class ThreeDVisual(QWidget):
    def __init__(self, main):
        ...
        self.longitude_label.setStyleSheet('QLabel { background-color : rgb(127, 127, 127); color: white}')
        self.longitude_value_label = QLabel()
        self.longitude_value_label.setStyleSheet('QLabel { background-color : rgb(127, 127, 127); color: white}')
        self.latitude_label = QLabel(_('Latitude:'))
        self.latitude_label.setStyleSheet('QLabel { background-color : rgb(127, 127, 127); color: white}')
        self.latitude_value_label = QLabel()
        self.latitude_value_label.setStyleSheet('QLabel { background-color : rgb(127, 127, 127); color: white}')
        self.magnet_label = QLabel(_('Magnet:'))
        self.magnet_label.setStyleSheet('QLabel { background-color : rgb(127, 127, 127); color: white}')
